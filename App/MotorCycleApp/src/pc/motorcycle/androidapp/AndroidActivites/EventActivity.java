...
public class EventActivity extends ListActivity 
{
		    ...
		    private static final String READ_COMMENTS_URL = "http://rideme.site88.net/events.php";
		   ...
		   //array to store events
		    ...
		    protected void onCreate(Bundle savedInstanceState) 
		    {
		        ...
		        //declare events button and set it unclickable
		        //since we are in that page
		        btnEvent = (Button) findViewById(R.id.btnEvents);
				btnEvent.setClickable(false);
				 
				//set view for rides button and wait for user click
				btnRides = (Button)findViewById(R.id.btnRide);
				btnRides.setOnClickListener(new View.OnClickListener() 
				{
					//go to rides class if clicked
					public void onClick(View v) 
					{
						Intent i = new Intent(EventActivity.this, RidesActivity.class);
						startActivity(i);
					}
				});
		    ...
		    protected void onResume() 
		    {
		        ...
		        super.onResume();
		        //reload events upon resume of application
		    ...
		    {
		        Intent i = new Intent(EventActivity.this, CreateActivity.class);
		        startActivity(i);
		    }
		    
		    //method to update json data in events
		    public void updateJSONdata() 
		    {
		    	//declare variables
		    	mEventsList = new ArrayList<HashMap<String, String>>();
		    	...
		    	JSONObject json = jParser.getJSONFromUrl(READ_COMMENTS_URL);
		    	        ...
		    	        try {
		    	        	//get JSON array
		    	            mEvents = json.getJSONArray(TAG_EVENTS);
		    ...
		    private void updateList() {
		    	...
		    	ListAdapter adapter = new SimpleAdapter(this, mEventsList,
		    ...
		    public class LoadEvents extends AsyncTask<Void, Void, Boolean> 
		    {
		        ...
		        {
		        	//load calls method to load events
		            super.onPreExecute();
		            pDialog = new ProgressDialog(EventActivity.this);
		            pDialog.setMessage("Loading Events...");//display loading message
